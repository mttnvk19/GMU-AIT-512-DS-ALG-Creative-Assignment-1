 ...
 * Project topic: Autonomous Vehicle
 * Task: Create a Bag that is related to the project topic
 * This is the interface for the AV Bag
 */

package m1ac;

/**
 * A bags is a data structures that collects items and allows us to iterate over them,
 * but does not allow removing items
 * @author matthew novak
 * @param <Item> the type of elements stored in the bag
 */
public interface Bagm1ac<Item> extends Iterable<Item> {
	/**
